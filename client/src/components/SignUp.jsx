...
class SignUp extends React.Component {
	...
	onSignUp() {
		const { userName, password, email, is_teacher, phone, location } = this.state;
	...
	render() {
		return (
			<form className="sign">
				...
				<input className="btn btn-primary" type="button" value="SignUp" onClick={this.onSignUp.bind(this)} />
